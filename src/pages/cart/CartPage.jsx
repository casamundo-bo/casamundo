                                                    ...
                                                    <div className="mb-2 flex">
                                                        ...
                                                        <div className="ml-6 flex text-sm">
                                                            <button onClick={() => deleteCart(item)} type="button" className="flex items-center space-x-1 px-2 py-1 pl-0">
                                                                ...
                                                                <span className="text-xs font-medium text-red-500">Quitar</span>
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div>
                                <dl className=" space-y-1 px-2 py-4">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <dd className="text-sm font-medium text-gray-900">Bs. {cartTotal}</dd>
                                    </div>
                                    <div className="flex items-center justify-between py-4">
                                        <dt className="flex text-sm text-gray-800">
                                            <span>Caracteristica de envio</span>
                                        </dt>
                                    ...
                                    <div className="flex items-center justify-between border-y border-dashed py-4 ">
                                        ...
                                        <dd className="text-base font-medium text-gray-900">Bs.  {cartTotal}</dd>
                                    </div>
                                </dl>
