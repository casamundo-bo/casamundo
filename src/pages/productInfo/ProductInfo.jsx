...
const ProductInfo = () => {
    ...
    const deleteCart = (product) => {
        dispatch(deleteFromCart({ item: product, userId: currentUser }));
    ...
    const hasStockControl = typeof product?.hasStockControl === 'boolean' 
                                ...
                                <div className="w-full px-4 md:w-1/2">
                                    <div className="lg:pl-20">
                                        <div className="mb-6 ">
                                            ...
                                            {/* Mostrar stock según control */}
                                            <p className="mt-2 text-gray-600">
                                                Stock: {!hasStockControl ? (
                                        ...
                                        <div className="flex flex-wrap items-center mb-6">
                                            {cartItems.some((p) => p.id === product.id)
                                                ...
                                                <button
                                                    ...
                                                    disabled={hasStockControl && product?.stock <= 0}
                                                >
                                                    {hasStockControl && product?.stock <= 0 ? 'Sin stock' : 'Agregar al carrito'}
                                                </button>
                                            }
                                        </div>
